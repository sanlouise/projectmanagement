class ProjectsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @project.update(project_params)
        format.html { redirect_to root_url, notice: 'The project was updated successfully.' }
      else
  ...
  def destroy
    @project.destroy
    respond_to do |format|
      format.html { redirect_to root_url, notice: 'The project was deleted successfully.' }
  ...
  private
    ...
    def verify_tenant
      unless params[:tenant_id] == Tenant.current_tenant_id.to_s
        redirect_to :root, 
        flash: {error: "You have no authorization to access projects of this organization." }
      end
    end
end
